...
public class ArduinoDeviceModel implements IArduinoDeviceModel {
    ...
    @Override
    public List<ArduinoDeviceEntity> getAll(Predicate predicate) {
        List<ArduinoDeviceEntity> deviceDTOS = new ArrayList<>();
        arduinoDeviceRepository.findAll(predicate).forEach(x -> deviceDTOS.add(x));
        return deviceDTOS;
    }
