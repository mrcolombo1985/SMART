...
public class FaceRec {
    ...
    public static void main(String[] args) {
        ...
        String imgToCheck = "c:\\Users\\tv\\Downloads\\SMART\\facedetect\\probes\\amber2.png";
        String imgDir = "c:\\Users\\tv\\Downloads\\SMART\\facedetect\\gallery\\";
        String numFaces = "1";
        String thresholdVal = "1.2";
    ...
    private String getMatchingFileName(@NotNull ImageDistanceInfo distanceInfo) {
    ...
    private Matrix2D getInputWeights(int selectedeigenfaces, @NotNull Matrix2D inputFace) {
    ...
    @NotNull
    @Contract("_ -> new")
    private ImageDistanceInfo getMinimumDistanceInfo(@NotNull double[] distances) {
    ...
    private double[] getDistances(@NotNull Matrix2D inputWt) {
    ...
    private double[][] calculateWeights(@NotNull FaceBundle b, int selectedNumOfEigenFaces) {
    ...
    @NotNull
    @Contract("_, _ -> new")
    private Matrix2D getNormalisedEigenFaces(Matrix2D imagesData, @NotNull Matrix2D eigenVectors) {
    ...
    private void getEigenValuesAsDouble(@NotNull double[] eigenValue, Double[] evals) {
        for (int i = 0; i < eigenValue.length; i++) {
            evals[i] = new Double(eigenValue[i]);
        }
    }

    private ArrayList<Double> sortKeysInReverse(@NotNull Hashtable<Double, double[]> table) {
    ...
    private void updateEigenValues(double[] eigenValue, @NotNull Double[] sortedkeys) {
    ...
    private void updateEigenVectors(double[][] eigenVector,
                                    Hashtable<Double, double[]> table, @NotNull Double[] evals,
    ...
    private void fillHashtable(@NotNull double[] eigenValues, double[][] eigenVectors,
    ...
    @Contract(pure = true)
    private double[] getColumn(@NotNull double[][] mat, int j) {
        int m = mat.length;
    ...
    private void setColumn(double[][] mat, @NotNull double[] col, int c) {
        int len = col.length;
    ...
    private Matrix2D getNormalisedImagesData(@NotNull BufferedImage[] bufImgs) {
        int imageWidth = bufImgs[0].getWidth();
        int imageHeight = bufImgs[0].getHeight();
    ...
    private void checkImageDimensions(List<String> filenames,
                                      @NotNull BufferedImage[] bufimgs) throws FaceRecError {
        int imgheight = 0;
        int imgwidth = 0;
    ...
    private void validateSelectedEigenFacesNumber(int selectedNumOfEigenFaces,
                                                  @NotNull List<String> newFileNames) throws FaceRecError {
    ...
    private List<String> getFileNames(String dir, @NotNull String[] children) {
    ...
    private void processCache(String dir, @NotNull List<String> newFileNames, @NotNull FaceBundle oldBundle, int selectedNumOfEigenFaces) throws FaceRecError, IOException {
    ...
    private void createImageFromArray(String filename, @NotNull double[] imgdata, int wd) throws IOException {
    ...
    private void deleteContents(@NotNull File f) {
    ...
    private void delete(@NotNull File i) {
        if (i.isFile()) {
    ...
    private double[][] getPhiData(Matrix2D egnfacesSubMatrix, @NotNull Matrix2D eigenvalsSubMatrix) {
    ...
    private double[][] addAverageFaceData(@NotNull double[][] phi) {
    ...
    private void reconstructOriginalImages(@NotNull double[][] xnew, String reconFolderName, String ext) throws IOException {
        String prefix;
        prefix = "xnew";
    ...
    private void reconstructPhiImages(@NotNull double[][] phi, String reconFolderName, String ext) throws IOException {
        int imgwidth = bundle.getImageWidth();
    ...
    private void validateSelectedImageFileName(@NotNull String faceimagename) throws FaceRecError {
    ...
    private void validateSelectedFolderName(@NotNull String foldername) throws FaceRecError {
